...
class ForgotPasswordTest extends TestCase
{
    ...
    public function setup(): void
    {
        ...
        $this->postRoute = route('v1_user.forgotPassword');
    }

    public function test_user_requests_for_password_reset_link()
    {
    ...
    public function test_logged_in_user_cannot_request_password_reset_link()
    {
        $this->withoutExceptionHandling();
    ...
    public function test_user_receives_the_password_reset_link_via_email()
    {
        Mail::fake();
        $this->withoutExceptionHandling();
    ...
    public function test_user_reset_password_mail_content()
    {
        $data = [
            'email' => 'user@example.com',
            'token' => 'random-string',
