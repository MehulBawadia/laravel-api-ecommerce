...
class UpdateShippingAddressTest extends TestCase
{
    ...
    public function setup(): void
    {
        ...
        $this->putRoute = route('v1_user.shippingAddress.update', $this->shippingAddress->id);
    }
    ...
    public function test_user_can_update_their_address()
    {
        ...
        $response->assertSeeText(__('response.user.address.success', ['type' => 'Shipping', 'action' => 'updated']));
    }
