...
class ResetPasswordTest extends TestCase
{
    ...
    public function setup(): void
    {
        ...
        $this->postRoute = route('v1_admin.resetPassword');
    }

    public function test_admin_resets_their_password()
    {
    ...
    public function test_admin_cannot_reset_password_if_already_logged_in()
    {
        $this->withoutExceptionHandling();
    ...
    public function test_admin_cannot_reset_password_if_token_has_expired()
    {
        $this->withoutExceptionHandling();
