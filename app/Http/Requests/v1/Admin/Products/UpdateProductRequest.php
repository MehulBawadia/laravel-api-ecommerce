...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'image' => 'nullable|file|mimes:jpg,jpeg,png,JPG,JPEG,PNG|max:1024',
    ...
    public function bodyParameters()
    {
        return [
            ...
            'image' => [
                'description' => 'Optional. The image of the product. Should be a valid file with a valid extension of either jpg, jpeg, or png. No other image file types are supported at the moment.',
            ],
            'description' => [
