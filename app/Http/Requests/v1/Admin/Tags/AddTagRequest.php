...
namespace App\Http\Requests\v1\Admin\Tags;
...
class AddTagRequest extends FormRequest
{
    ...
    public function bodyParameters()
    {
        return [
            'name' => [
                'description' => 'Required. The name of the tag, should be unique.',
                'example' => 'T-shirt for Women',
            ],
            'description' => [
                'description' => 'Required. The description of the tag.',
            ...
            'meta_keywords' => [
                'description' => 'A comma separated words or phrases related to the tag.',
